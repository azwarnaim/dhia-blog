  ...
  of: [
    {
      ...
      marks: {
        ...
        decorators: [
          ...
          {title: 'Justify', value: 'justify', icon:FaAlignJustify, component: (props) => TextAlign(props)},
          {title: 'Left', value: 'left', icon:FaAlignLeft, component: (props) => TextAlign(props)},
          {title: 'Center', value: 'center', icon:FaAlignCenter, component: (props) => TextAlign(props)},
          {title: 'Right', value: 'right', icon:FaAlignRight, component: (props) => TextAlign(props)},
